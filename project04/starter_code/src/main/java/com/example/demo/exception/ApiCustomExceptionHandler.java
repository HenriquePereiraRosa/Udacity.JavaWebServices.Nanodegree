...
import com.example.demo.exception.custom.CouldNotBeNullException;
import com.example.demo.exception.custom.DuplicatedResourceException;
...
public class ApiCustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Error when user is not found on login
    @ExceptionHandler({UserNotFoundException.class})
    public ResponseEntity<Object> handleUserNotFoundExceptionException(UserNotFoundException ex, WebRequest request) {
        String userMsg = messageSource.getMessage("security.invalid.username.pass", null, LocaleContextHolder.getLocale());
